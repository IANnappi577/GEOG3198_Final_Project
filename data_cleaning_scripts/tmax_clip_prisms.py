...
all_months_2015 = sorted(glob('../data/tmax/2015/prism_tmax_us*.tif'))
...
with rasterio.open('../data/tmax/2015/tmax_months_stacked_2015.tif', 'w', **stacked_profile) as dst:
...
with rasterio.open('../data/tmax/2015/tmax_months_stacked_2015.tif') as src:
...
with rasterio.open('../data/tmax/2015/tmax_months_stacked_clipped_2015.tif', 'w', **clipped_profile) as dst:
    dst.write(out_image)
...
# find all month bands using glob
all_months_2025 = sorted(glob('../data/tmax/2025/prism_tmax_us*.tif'))
...
with rasterio.open('../data/tmax/2025/tmax_months_stacked_2025.tif', 'w', **stacked_profile) as dst:
...
with rasterio.open('../data/tmax/2025/tmax_months_stacked_2025.tif') as src:
    # Guide to using clip() on a raster:
    # https://gis.stackexchange.com/questions/444062/clipping-raster-geotiff-with-a-vector-shapefile-in-python
    out_image, out_transform = mask(src, dc_bounds.geometry, crop=True)
    clipped_profile = src.meta.copy()
...
with rasterio.open('../data/tmax/2025/tmax_months_stacked_clipped_2025.tif', 'w', **clipped_profile) as dst:
    dst.write(out_image)
...
with rasterio.open('../data/tmax/2015/tmax_months_stacked_clipped_2015.tif') as src:
...
with rasterio.open('../data/tmax/2025/tmax_months_stacked_clipped_2025.tif') as src:
    # read the data and convert it to float + np.nan as nodata to display
...
ax1.set_title('2015 tmax')
plt.colorbar(im1, ax=ax1)

im2 = ax2.imshow(prism_data_2025, cmap='Greens')
ax2.set_title('2025 tmax')
